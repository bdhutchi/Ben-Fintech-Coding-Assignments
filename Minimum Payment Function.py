...
def find_minimum_payment(balance, annualInterestRate, term, epsilon):
n = 1
low=balance / term
...
print(find_minimum_payment(balance,annualInterestRate,term,epsilon)
#print(balance)
